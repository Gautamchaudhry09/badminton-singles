...
(function () {
  ...
  function installChrome() {
    ...
    css.textContent = [
      ...
      'background:var(--cork-pale);border:1px solid #DFC48E;border-left:3px solid var(--cork);',
      ...
      'color:var(--ink-soft);font:700 12px/1 var(--cond);letter-spacing:.07em;',
      ...
      '.sy-quiet{color:#3F544A;font:400 11.5px/1.2 var(--sans);letter-spacing:0;',
      ...
      '.sy-when{font:400 11.5px/1.2 var(--sans);color:#3F544A}',
      '.sy-bin{appearance:none;background:transparent;border:0;cursor:pointer;margin-left:auto;',
      'color:#3F544A;font:400 11.5px/1.2 var(--sans);padding:2px 3px;min-height:auto}',
      ...
      '.sy-empty{margin:0 0 12px;font:400 13.5px/1.4 var(--sans);color:#3F544A;font-style:italic}',
      ...
      '.sy-asyou{margin:8px 0 0;font:400 12px/1.3 var(--sans);color:#3F544A}',
      ...
      '.sy-ask-btn{flex:1 1 0;appearance:none;cursor:pointer;border-radius:10px;min-height:44px;',
      ...
      '.p2 .sy-medal{background:#6F857C}',
      '.p3 .sy-medal{background:#8F5F2C}',
      '.p4 .sy-medal{background:#AFC0B7;color:#243029}',
      ...
      '.sy-what{font:700 11.5px/1.3 var(--cond);letter-spacing:.08em;text-transform:uppercase;',
      'color:#3F544A;margin-top:2px}',
      '.p1 .sy-what{color:var(--cork-text)}',
      '.sy-detail{font:400 13px/1.3 var(--sans);color:#3F544A;margin-top:3px}',
      '.sy-place.sy-waiting{border-style:dashed;background:transparent}',
      '.sy-waiting .sy-name{font-weight:500;color:var(--ink-soft)}',
      '.sy-waiting .sy-medal{background:transparent;color:#5A6E64;',
