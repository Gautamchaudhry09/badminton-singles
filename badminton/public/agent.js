...
(function () {
  ...
  function styles() {
    return [
      ...
      '#ai-clear{appearance:none;background:transparent;border:0;color:#A9C9C0;cursor:pointer;',
      'font:500 12.5px/1 var(--sans);padding:3px 2px;min-height:auto;text-decoration:underline}',
      '#ai-clear:hover{color:#fff}',
      '#ai-close{appearance:none;background:transparent;border:0;color:#A9C9C0;cursor:pointer;',
      ...
      '.ai-msg.oops{align-self:flex-start;background:var(--cork-pale);border:1px solid #E8D2A8;',
      'color:var(--cork-text)}',
      '.ai-did{align-self:flex-start;font-size:12px;color:var(--ink-soft);padding:0 3px;font-style:italic}',
      '.ai-dots{align-self:flex-start;color:var(--ink-soft);font-size:14px;padding:6px 11px}',
